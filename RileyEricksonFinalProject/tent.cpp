// Generates the vertices, colors, and normals of a unit tent
...
void
tent::quad( int a, int b, int c, int d , int col, int norm)
{
...
void
tent::createVAO(GLint _vao, GLint program )
{
    vao = _vao;
